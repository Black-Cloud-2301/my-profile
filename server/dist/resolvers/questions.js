...
let QuestionsResolver = class QuestionsResolver {
    questions() {
        return __awaiter(this, void 0, void 0, function* () {
            return Questions_1.Questions.find();
        });
    }
};
__decorate([
    (0, type_graphql_1.Query)((_return) => [Questions_1.Questions], { nullable: true }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], QuestionsResolver.prototype, "questions", null);
QuestionsResolver = __decorate([
    (0, type_graphql_1.Resolver)((_of) => Questions_1.Questions)
], QuestionsResolver);
